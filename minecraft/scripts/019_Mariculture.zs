...
recipes.addShaped(<Railcraft:tile.railcraft.machine.alpha:12>, [[<minecraft:gravel>, <TConstruct:materials:2>, <minecraft:gravel>], [<TConstruct:materials:2>, <minecraft:gravel>, <TConstruct:materials:2>], [<minecraft:gravel>, <TConstruct:materials:2>, <minecraft:gravel>]]);
recipes.remove(<Railcraft:tile.railcraft.brick.infernal:2>);
recipes.addShaped(<Railcraft:tile.railcraft.brick.infernal:2>, [[<minecraft:gravel>, <TConstruct:materials:2>], [<TConstruct:materials:2>, <minecraft:gravel>]]);
