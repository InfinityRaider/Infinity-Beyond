...
recipes.addShaped(<Railcraft:machine.beta:8>, [[<Railcraft:part.plate:0>, <Railcraft:part.plate:0>, <Railcraft:part.plate:0>], [null, <ore:blockGlass>, null], [<ore:gearIron>, <minecraft:piston>, <ore:gearIron>]]);
recipes.addShaped(<Railcraft:machine.beta:7>, [[<ore:ingotCopper>, <ore:ingotCopper>, <ore:ingotCopper>], [null, <ore:blockGlass>, null], [<ore:gearCopper>, <minecraft:piston>, <ore:gearCopper>]]);
